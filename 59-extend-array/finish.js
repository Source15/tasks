...
const instanse = new ExtendedArray(1, 2, 4, 5);
const instanse2 = new ExtendedArray('abc', true, 2, 4, 5);

console.log(instanse.sum());
console.log(instanse2.onlyNumbers());

instanse2.forEach((num) => console.log(num));
